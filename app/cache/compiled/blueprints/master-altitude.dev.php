...
return [
    ...
    'timestamp' => 1495512189,
    'checksum' => 'd61dfabe177c625a76d6d9327187544a',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/import' => [
                'file' => 'user/plugins/import/blueprints.yaml',
                'modified' => 1495485072
            ],
            'plugins/login' => [
            ...
            'plugins/scheduler' => [
                'file' => 'user/plugins/scheduler/blueprints.yaml',
                'modified' => 1495485081
            ],
    ...
    'data' => [
        'items' => [
            ...
            'plugins.scheduler.enabled' => [
                ...
                'name' => 'plugins.scheduler.enabled',
                'validation' => 'strict'
            ],
            'plugins.shoppingcart' => [
                'form' => [
